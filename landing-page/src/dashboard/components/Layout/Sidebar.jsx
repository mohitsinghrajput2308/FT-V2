...
import {
    ...
    HelpCircle, List, Tags, ChevronLeft, ChevronRight, X, Terminal, Star, MessageCircle
} from 'lucide-react';

const menuItems = [
    { path: '/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
    { path: '/dashboard/income', icon: ArrowUpCircle, label: 'Income' },
    { path: '/dashboard/expenses', icon: ArrowDownCircle, label: 'Expenses' },
    { path: '/dashboard/budgets', icon: Wallet, label: 'Budgets' },
    ...
    { path: '/dashboard/support', icon: MessageCircle, label: 'Priority Support' },
