...
import { BookOpen, Sparkles, Clock, User, Tag, ArrowRight, Search } from 'lucide-react';
...
const posts = [
  ...
  { title: 'Why Honest Metrics Matter', excerpt: 'A look at why our startup chooses truthful numbers over inflated metrics — and why it builds more trust.', category: 'Engineering', author: 'FinTrack Team', date: 'Mar 15, 2025', readTime: '6 min', gradient: 'from-pink-500 to-rose-500' },
  { title: 'Financial Wellness & Digital Privacy', excerpt: 'How data privacy and security are essential to your financial wellbeing, and how we protect yours.', category: 'Finance Tips', author: 'FinTrack Team', date: 'Mar 8, 2025', readTime: '5 min', gradient: 'from-violet-500 to-purple-500' },
];
