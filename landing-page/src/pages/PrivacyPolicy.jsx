...
const sections = [
  { icon: Eye, title: 'Data Collection', color: 'blue', items: ['We collect only essential account data (email, name, financial records you input)', 'Minimal analytics: Google Analytics (aggregated) and Crisp Chat (support tool) — never financial data', 'Anonymous usage metrics to improve app performance — never tied to your identity', 'You choose what data to share — nothing is mandatory beyond email'] },
  { icon: Lock, title: 'Data Encryption', color: 'emerald', items: ['All data encrypted at rest using AES-256 encryption', 'TLS 1.2+ for all data in transit — TLS 1.3 rollout in progress', 'Database-level Row Level Security (RLS) on every table', 'Your password is hashed with bcrypt — we never store it in plain text'] },
  { icon: Server, title: 'Data Storage', color: 'purple', items: ['Hosted on Supabase infrastructure (Supabase holds SOC 2 Type II certification)', 'Data stored in isolated tenant environments', 'Automated backups every 24 hours with 30-day retention', 'You can export or delete all your data at any time'] },
  { icon: Globe, title: 'Third Parties', color: 'amber', items: ['We do NOT sell your data to any third party — ever', 'No advertising networks have access to your information', 'Essential service providers (hosting, payments, analytics, support) access aggregated metadata only', 'All third-party services are vetted and GDPR compliant'] },
